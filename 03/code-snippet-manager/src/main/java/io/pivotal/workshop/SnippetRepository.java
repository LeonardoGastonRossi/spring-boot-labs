...
import io.pivotal.workshop.NewSnippetFields;
import io.pivotal.workshop.SnippetRecord;
...
public class SnippetRepository {
    ...
    private List<SnippetRecord> snippets =
            new ArrayList<SnippetRecord>() {
                {
    ...
    public SnippetRecord findById(String id) {
        return snippets.stream().filter(snippet -> snippet.id.equals(id))
                .findFirst()
